    ...
    <ul class="nav-menu dark-bg-1">
        ...
        <li class="nav-box nav-bg-change">
            <a href="about.php" class="animsition-link pointer-large nav-link">
                <span class="nav-btn active" data-text="Մեր Մասին">Մեր Մասին</span>
            </a>
...
<main class="animsition-overlay" data-animsition-overlay="true">
    ...
    <section id="up" class="page-head flex-min-height-box dark-bg-1">
        ...
        <div class="page-head-bg overlay-loading2"
             style="background-image: url(../images/backgrounds/unnamed.jpg);"></div>
                ...
                <div class="six-columns six-offset">
                    <div class="content-left-margin-40">
                        <h2 class="large-title-bold">
                            <span class="load-title-fill tr-delay03 blogSize" data-text="Մեր մասին">Check our</span><br>
                            <span class="load-title-fill tr-delay04 blogSize" data-text="">latest news</span><br>
                ...
                <div data-animation-container class="flex-container">
                    ...
                    <div class="eight-columns">
                        <div class="content-left-margin-10">
                            <p data-animation-child class="p-style-large text-color-5 fade-anim-box tr-delay01" data-animation="fade-anim">Սատուռն Կոդ ընկերությունը սկսել է
                    ...
                    <div class="four-columns top-padding-60">
                        <div class="content-right-margin-20">
                            <h6 data-animation-child class="small-title-oswald title-fill tr-delay02" data-animation="title-fill-anim" data-text="Front-end">Front-end</h6>
                            <ul class="list-dots">
                                <li>
                                    <p data-animation-child class="p-letter-style text-color-4 fade-anim-box tr-delay03" data-animation="fade-anim">HTML, CSS, Bootstrap</p>
                                </li>
                                <li>
                                    <p data-animation-child class="p-letter-style text-color-4 fade-anim-box tr-delay04" data-animation="fade-anim">Javascript</p>
                                </li>
                                <li>
                                    <p data-animation-child class="p-letter-style text-color-4 fade-anim-box tr-delay04" data-animation="fade-anim">Jquery, React js</p>
                                </li>
                            </ul>
                        </div>
                    </div><!-- column end -->
                    ...
                    <div class="four-columns top-padding-60">
                        <div class="content-left-right-margin-10">
                            <h6 data-animation-child class="small-title-oswald title-fill tr-delay02" data-animation="title-fill-anim" data-text="Back end">Back end</h6>
                            <ul class="list-dots">
                                <li>
                                    <p data-animation-child class="p-letter-style text-color-4 fade-anim-box tr-delay03" data-animation="fade-anim">PHP</p>
                                </li>
                                <li>
                                    <p data-animation-child class="p-letter-style text-color-4 fade-anim-box tr-delay04" data-animation="fade-anim">Laravel</p>
                                </li>
                            </ul>
                        </div>
                    </div><!-- column end -->
    ...
    <section class="light-bg-1 top-bottom-padding-120" data-midnight="black">
        ...
        <div data-animation-container class="container small bottom-padding-60">
            <div class="text-center">
                <h2 data-animation-child class="large-title text-color-1 overlay-anim-box2" data-animation="overlay-anim2">Saturn Code</h2>
            </div>
            <div class="top-margin-30">
                <h3 data-animation-child class="small-title-oswald text-color-2 text-height-20 fade-anim-box tr-delay01" data-animation="fade-anim">Սատուռն Կոդ ընկերությունը մասնագիտացած է
                    ...
                    բազմաստիճան որակի վերահսկում արտադրանքի ստեղծման բոլոր փուլերում:</h3>
                <p data-animation-child class="p-style-xsmall text-color-1 fade-anim-box tr-delay02" data-animation="fade-anim"></p>
                <p data-animation-child class="p-style-xsmall text-color-1 fade-anim-box tr-delay03" data-animation="fade-anim"></p>
                <p data-animation-child class="p-style-xsmall text-color-1 fade-anim-box tr-delay04" data-animation="fade-anim"></p>
            </div>
        </div><!-- container end -->
        ...
        <div class="about-slider bottom-padding-60">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="../images/about/developr2.png" alt="about">
                </div>
                <div class="swiper-slide">
                    <img src="../images/about/Web-Developer.jpg" alt="about">
                </div>
                <div class="swiper-slide">
                    <img src="../images/about/developr3.jpg" alt="about">
                </div>
        ...
        <div class="three-columns bottom-padding-60">
            <div class="content-left-right-margin-10">
                <ul class="footer-menu text-color-4">
                    ...
                    <li><a class="pointer-large animsition-link small-title-oswald hover-color active" href="#">Մեր Մասին</a></li>
                    <li><a class="pointer-large animsition-link small-title-oswald hover-color" href="services.php">Ծառայություններ</a></li>
