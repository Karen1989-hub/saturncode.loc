...
<main class="animsition-overlay" data-animsition-overlay="true">
    ...
    <section id="up" class="page-head flex-min-height-box dark-bg-1">
        <!-- page-head-bg -->
        <div class="page-head-bg overlay-loading2" style="background-image: url(../images/backgrounds/contactbg.jpg);"></div>
            ...
            <div class="container top-padding-120 bottom-padding-60">
                <div data-animation-container>
                    <h2 class="large-title text-center">
                        <span data-animation-child class="title-fill" data-animation="title-fill-anim" data-text="Կապ մեզ հետ">Կապ մեզ հետ</span>
                    </h2>
                    <p data-animation-child class="p-style-small text-color-5 fade-anim-box tr-delay03" data-animation="fade-anim">Մեր աշխատակիցները հնարավորինս շուտ կպատասխանեն ձեզ: Ձեր նամակը կամ զանգը կարևոր է մեզ համար:</p>
                </div>
    ...
    <section class="contact-form-box flex-min-height-box" style="background-image:url(../images/backgrounds/pexels-photo-1287145.jpg)">
        <div class="bg-overlay"></div>
        <!-- flex-min-height-inner start -->
        <div class="flex-min-height-inner">
            <!-- container start -->
            <div class="container small top-bottom-padding-120">
                <h4 class="small-title-oswald text-color-4 text-center">Գրեք մեզ այստեղ</h4>
                <!-- flex-container start -->
                <form class="flex-container top-padding-90">
                    <!-- column start -->
                    <div class="four-columns">
                        <div class="content-right-margin-10">
                            <input type="text" placeholder="Ներմուծեք ձեր անունը" class="contact-form-control pointer-small">
                        </div>
                    </div><!-- column end -->
                    <!-- column start -->
                    <div class="four-columns">
                        <div class="content-left-right-margin-5">
                            <input type="text" placeholder="Ներմուծեք ձեր ազգանունը" class="contact-form-control pointer-small">
                        </div>
                    </div><!-- column end -->
                    <!-- column start -->
                    <div class="four-columns">
                        <div class="content-left-margin-10">
                            <input type="email" placeholder="Ներմուծեք ձեր էլ.հասցեն" class="contact-form-control pointer-small">
                        </div>
                    </div><!-- column end -->
                    <!-- column start -->
                    <div class="twelve-columns">
                        <textarea placeholder="Ներմուծեք ձեր հաղորդագրությունը" class="contact-form-control pointer-small"></textarea>
                    </div><!-- column end -->
                    <!-- column start -->
                    <div class="twelve-columns text-center top-padding-90">
                        <button class="border-btn-box pointer-large">
									<span class="border-btn-inner">
								      	<span class="border-btn" data-text="ուղարկել">submit</span>
								    </span>
                        </button>
                    </div><!-- column end -->
        ...
        <div class="three-columns bottom-padding-60">
            <div class="content-left-right-margin-10">
                <ul class="footer-menu text-color-4">
                    ...
                    <li><a class="pointer-large animsition-link small-title-oswald hover-color active" href="contact.php">Հետադարձ Կապ</a></li>
                </ul>
            </div>
        </div><!-- column end -->
        <!-- column start -->
...
<!-- Mirrored from www.nurseitmukaytegin.com/envato-templates/xen/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Apr 2020 15:32:58 GMT -->
</html>