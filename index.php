                ...
                <div data-animation-container class="flex-container">
                    ...
                    <div class="twelve-columns text-center">
                        <h2 class="large-title text-height-12">
                            <span data-animation-child class="title-fill" data-animation="title-fill-anim" data-text="Մենք կրեատիվ ենք">Մենք կրեատիվ ենք</span><br>
                            <span data-animation-child class="title-fill tr-delay01" data-animation="title-fill-anim" data-text="Մենք Սատուռն Կոդն ենք">Մենք Սատուռն Կոդն ենք</span>
                        </h2>
                    </div><!-- column end -->
                    <!-- column start -->
                    ...
                    <div class="flex-container container small">
                        ...
                        <div class="six-columns top-padding-60">
                            <a href="project.html" class="portfolio-content-bg-box pointer-large hover-box hidden-box animsition-link">
                                <div class="portfolio-content-bg hover-img overlay-anim-box2 overlay-dark-bg-2" data-animation="overlay-anim2" style="background-image:url(images/projects/webdesign.jpg)"></div>
                            </a>
                        </div><!-- column end -->
                    </div><!-- flex-container end -->
            ...
            <div class="portfolio-content flex-min-height-box">
                ...
                <div class="portfolio-content-inner flex-min-height-inner">
                    ...
                    <div class="flex-container reverse container small">
                        ...
                        <div class="six-columns top-padding-60">
                            <a href="project.html" class="portfolio-content-bg-box pointer-large hover-box hidden-box animsition-link">
                                <div class="portfolio-content-bg hover-img overlay-anim-box2 overlay-dark-bg-2" data-animation="overlay-anim2" style="background-image:url(images/projects/web_dizain.jpg)"></div>
                            </a>
                        </div><!-- column end -->
                        <!-- column start -->
                        <div data-animation-container class="six-columns">
                            <div class="content-left-margin-40">
                                <span class="small-title-oswald red-color overlay-anim-box2" data-animation="overlay-anim2">Գրաֆիկական դիզայն</span>
                                <h3 class="title-style text-color-1">
                    ...
                    <div class="flex-container container small">
                        ...
                        <div data-animation-container class="six-columns">
                            <div class="content-right-margin-40">
                                ...
                                <h3 class="title-style text-color-1">
                                    <span data-animation-child class="overlay-anim-box2 overlay-dark-bg-2 tr-delay01" data-animation="overlay-anim2">Որոնողական առաջխաղացում (SEO)</span><br>
                        ...
                        <div class="six-columns top-padding-60">
                            <a href="project.html" class="portfolio-content-bg-box pointer-large hover-box hidden-box animsition-link">
                                <div class="portfolio-content-bg hover-img overlay-anim-box2 overlay-dark-bg-2" data-animation="overlay-anim2" style="background-image:url(images/projects/seoprodvij.jpg)"></div>
                            </a>
                        </div><!-- column end -->
                    </div><!-- flex-container end -->
                </div><!-- portfolio-content-inner end -->
    ...
    <section class="dark-bg-2">
        ...
        <div class="container small top-bottom-padding-120">
            ...
            <h2 data-animation-container class="medium-title">
                <span data-animation-child class="title-fill tr-delay01" data-animation="title-fill-anim" data-text="Մեր">Մեր</span><br>
                <span data-animation-child class="title-fill tr-delay02" data-animation="title-fill-anim" data-text="գործընկերները">գործընկերները</span>
            </h2><!-- medium-title end -->
            ...
            <ul class="client-list d-flex-wrap top-padding-60">
                ...
                <li>
                    <a href="#" class="pointer-large d-block">
                        <div class="brand-box">
                            <img src="images/clients/d5f831cf-3fb0-490b-aadc-3591c8b64156.png" alt="Brand" class="hover-opac-img">
                            <img src="images/clients/2ed0436b-e3ea-48aa-85ca-755de0719c9a.png" alt="Brand" class="opac-img">
                        </div>
                    </a>
                </li>
                <li>
                    <a href="#" class="pointer-large d-block">
                        <div class="brand-box">
                            <img src="images/clients/d51e13e6-1320-4227-8bc8-c36aaa82dffd.png" alt="Brand" class="hover-opac-img">
                            <img src="images/clients/aed14647-8ecf-4fef-8274-737d79a7ede1.png" alt="Brand" class="opac-img">
                        </div>
                    </a>
                </li>
                <li>
                    <a href="#" class="pointer-large d-block">
                        <div class="brand-box">
                            <img src="images/clients/d383cf8d-abee-4290-810d-a965f6c0fa6c.png" alt="Brand" class="hover-opac-img">
                            <img src="images/clients/7f7b6ede-3a3e-4e17-af25-f881c0121d63.png" alt="Brand" class="opac-img">
                        </div>
                    </a>
                </li>
                <li class="empty-spot-box">
                    <a data-animation-container href="#" class="pointer-large p-style-bold-up empty-spot d-block">
                        <span data-animation-child class="title-fill" data-animation="title-fill-anim" data-text="Այս դաշտը">Այս դաշտը</span>
                        <span data-animation-child class="title-fill tr-delay01" data-animation="title-fill-anim" data-text="Սպասում է">Սպասում է</span>
                        <span data-animation-child class="title-fill tr-delay02" data-animation="title-fill-anim" data-text="Քեզ">Քեզ</span>
                    </a>
                </li>
            </ul><!-- client-list end -->
        </div><!-- container end -->
                    ...
                    <article class="content-right-margin-20 light-bg-2" data-animation-container>
                        <a href="single_post.html" class="pointer-large animsition-link hover-box d-block">
                            ...
                            <h3 class="title-style text-color-1 top-margin-30 blog-title content-padding-l-r-20">
                                <span data-animation-child class="overlay-anim-box2 hover-content overlay-dark-bg-2 tr-delay01" data-animation="overlay-anim2">Սատուռն կոդը</span><br>
                                <span data-animation-child class="overlay-anim-box2 hover-content overlay-dark-bg-2 tr-delay02" data-animation="overlay-anim2">աջակցում է մանր</span><br>
                                <span data-animation-child class="overlay-anim-box2 hover-content overlay-dark-bg-2 tr-delay03" data-animation="overlay-anim2">ու միջին բիզնեսին</span>
                            </h3>
                        </a>
                        <div class="content-padding-bottom-20 content-padding-l-r-20">
                            ...
                            <div data-animation-child class="blog-autor-date top-margin-30 fade-anim-box tr-delay06 text-color-1" data-animation="fade-anim">
                                <a class="xsmall-title-oswald pointer-small hover-color" href="#">Արոյան Կարեն</a>
        ...
        <div class="three-columns bottom-padding-60">
            <div class="content-left-right-margin-10">
                <ul class="footer-menu text-color-4">
                    ...
                    <li><a class="pointer-large animsition-link small-title-oswald hover-color" href="views/about.php">Մեր Մասին</a></li>
                    <li><a class="pointer-large animsition-link small-title-oswald hover-color" href="views/services.php">Ծառայություններ</a></li>
                    <li><a class="pointer-large animsition-link small-title-oswald hover-color" href="#">Պորտֆոլիո</a></li>
                    <li><a class="pointer-large animsition-link small-title-oswald hover-color" href="views/blog.php">Բլոգ</a></li>
